...
doParallel = Logical Parameter. When set True, the Model-Process will paralellize on all cores except two, so your PC will slow down a lot. Only recomended for PCs with at least 8 Cores. Warning: Your PC wont be able to process other stuff efficiently during paralellization.\
